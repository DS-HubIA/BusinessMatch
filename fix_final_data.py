...
with app.app_context():
    echo "Recriando banco com estrutura 100% correta"
    ...
    echo "DADOS CRIADOS"
    echo "Usuários: $(python -c 'from app import create_app; from app.models import User; app=create_app(); with app.app_context(): print(User.query.count())')"
    echo "Oportunidades: $(python -c 'from app import create_app; from app.models import Opportunity; app=create_app(); with app.app_context(): print(Opportunity.query.count())')"
